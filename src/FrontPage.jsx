    ...
    >
      ...
      >
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <img src="/axernai.png" alt="Axern" className="h-8 w-auto" />
            <span
      ...
      <div className="container mx-auto px-6 py-8 pt-24">
        <header className="text-center mb-12 mt-8">
          ...
          <div className="mt-3">
            <DecryptedText
              text="Bring your thoughts to life with custom prompts"
              animateOn="view"
              speed={100}
              maxIterations={20}
          ...
          >
            Generate useful prompts to boost your ideas and productivity
          </p>
        </header>
          ...
          >
            ...
            <textarea
              ...
              className={`w-full h-32 ${
                darkMode
                  ...
                  : "bg-gray-50 text-gray-800 border-gray-300 focus:ring-blue-500"
              } rounded-lg p-4 focus:outline-none focus:ring-2 resize-none border`}
            />
            <div className="flex justify-end mt-4">
              <button
                ...
                } disabled:cursor-not-allowed text-white rounded-lg py-2.5 px-6 flex items-center gap-2 font-medium transition-all duration-300 shadow-md`}
              >
                {loading ? (
            ...
            <div
              className={`${
                darkMode
                  ? "bg-gray-800 border-gray-700"
                  : "bg-white border-gray-200"
              } rounded-xl p-6 shadow-lg border transition-all duration-500 ease-in-out`}
            >
              ...
              >
                ...
                >
                  <ReactMarkdown
                    className="text-black dark:text-white whitespace-pre-line"
                    components={{
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  >
                    Generate enterprise-grade prompts with a single click.
                ...
                >
                  ...
                  >
                    Tailored prompts optimized for your industry and specific
                ...
                >
                  ...
                  >
                    Dedicated infrastructure ensures rapid response times and
                    reliable service for all your business needs.
                  </p>
                </div>
              </div>
            </div>
        ...
        {showHistory && (
          <div
            ref={historyRef}
            className={`fixed right-0 top-0 w-full sm:w-96 h-full ${
              darkMode
                ? "bg-gray-800 shadow-2xl border-l border-gray-700"
              ...
              {historyLoading ? (
                ...
                chatHistory.map((chat) => (
                  <div
                    ...
                    className={`${
                      darkMode
                        ? "bg-gray-700 rounded-lg p-4 space-y-3 relative border border-gray-600 hover:border-blue-500"
                        : "bg-gray-50 rounded-lg p-4 space-y-3 relative border border-gray-200 hover:border-blue-200"
                    } transition-colors`}
                  >
                    <button
                      ...
                      className={`absolute top-3 right-3 ${
                        darkMode
                          ? "text-gray-400 hover:text-red-400 bg-gray-600 hover:bg-gray-500"
                          : "text-gray-400 hover:text-red-500 bg-gray-200 hover:bg-gray-300"
                      } rounded-full p-1.5 transition-colors`}
      ...
      <footer
        className={`${
          darkMode
            ? "bg-gray-800 py-6 border-t border-gray-700"
            : "bg-white py-6 border-t border-gray-200"
        } mt-16`}
      >
