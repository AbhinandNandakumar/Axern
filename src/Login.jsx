...
const Login = () => {
  ...
  return (
   <div className="fixed  flex justify-center items-center min-h-screen inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/rrrainbow.svg'), linear-gradient(to bottom right, #4c1d95, #1e40af, #000000)" }}>

      <div className="bg-gray-900/60 p-6 rounded-lg  w-full max-w-md border border-gray-700  backdrop-blur-sm  shadow-md">
  ...
  >
    Resend Verification Email
        ...
        {/* Google Sign In */}
        <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center border border-gray-600 py-2 px-4 rounded-md hover:bg-gray-700 bg-white text-black">
